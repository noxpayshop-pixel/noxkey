    ...
    <section className="py-28 px-6 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="group relative overflow-hidden rounded-3xl border border-border nox-surface p-10 nox-card-shine nox-hover-glow">
            <div className="relative z-10">
              <div className="w-16 h-16 rounded-2xl nox-gradient flex items-center justify-center mb-8 shadow-lg shadow-primary/20">
          ...
          <div className="group relative overflow-hidden rounded-3xl border border-border nox-surface p-10 nox-card-shine nox-hover-glow">
            <div className="relative z-10">
              <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[hsl(var(--accent))] to-[hsl(var(--primary))] flex items-center justify-center mb-8 shadow-lg shadow-accent/20">
